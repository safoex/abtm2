...
#ifndef ABTM2_ROSSIMPLEACTIONCLIENT_H
#define ABTM2_ROSSIMPLEACTIONCLIENT_H

#include "ROSTopic.h"

namespace abtm {

    class ROSSimpleActionClient : public IOInterface {
    protected:
    ...
    public:
        ...
        ROSSimpleActionClient(RosbridgeWsClient& rbc, std::string const& _as_name, std::string const& _package,
            ...
            trigger_vars = {{cancel_var, double(0)},{goal_id_var, double(0)}};
            required_vars = trigger_vars;
...
#endif //ABTM2_ROSSIMPLEACTIONCLIENT_H
